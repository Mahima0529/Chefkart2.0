...
function Crousel() {
   ...
   const fetchCarouselData = async () => {
      try {
         const response = await api.get("/crousel/get");
   ...
   const handleDelete = async (id) => {
      try {
         await api.delete(`/crousel/delete/${id}`);
   ...
   const handleCreateOrUpdate = async () => {
      try {
         if (isEditMode) {
            await api.put(`/crousel/update/${editId}`, formData);
         } else {
            await api.post("/crousel/createCrousel", formData);
         }
