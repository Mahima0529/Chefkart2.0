...
function Homepage() {
   ...
   const handleDelete = async (blogId) => {
      try {
         await api.delete(`/home/delete/${blogId}`);
   ...
   const handleCreateOrUpdate = async () => {
      try {
         if (isEditMode) {
            await api.put(`/home/update/${editId}`, formData);
         } else {
            await api.post("/home/createHomePage", formData);
         }
   ...
   return (
      <div className="p-6 min-h-screen bg-gray-100">
         <TitleCard title="Homepage Content Management">
            <div className="mb-6">
               <button
