  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        ...
        console.warn("Using default authentic images:", error);
      }
    };
          ...
          >
            ...
            >
              <img
                ...
                alt={`Party feast dish zoomed ${zoomedIndex + 1}`}
